...
//			Student studentAtNow = list.get(i);
//			int id = studentAtNow.id;
//			map.put(id, studentAtNow);
//		}
//	} // 문제 1-2
//
...
//		List<Student> tempList = new ArrayList<>(map.values());
...
////				for (Entry<Integer, Student> ent : map) {
...
//			String studentName = val.name;
//			for (String name : nameList) {
//				if (studentName.equals(name))
//					nameMap.put(name, val);
//			}
//		}
//		return nameMap; // 구현시 수정할 것것
//	}
//}
//
//class Executor {
