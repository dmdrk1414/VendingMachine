...
배운 문법을 사용하여 원하는 기능을 추가하여 거대한 자판기를 만든는 것이 목표입니다.
...
- 왜 그 기술을 사용했는지 : 자바를 사용합니다. 학교에서 배우는 언어가 자바이고, 잘하고 싶은 언어가 자바라 시작하엿습니다. <br>
...
#### 💎 2022-10-04 관리자가 음료수의 등록과 삭제 업데이트를 관리 하도록 만들고 싶습니다. 

이넘으로 물건관리를 할려고했지만 적절하지 않은 것같은 생각이 드네요...?
